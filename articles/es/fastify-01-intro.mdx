...
- Cuenta con una comunidad muy efectiva y creciente.
- La arquitectura del Framework permite dentro del mismo código especificar esquemas validaciones
  y un muy claro ciclo de vida.
...
el path de la ruta y como segundo argumento la función callback de las acciones a ejecutar cuando se alcance
...
va a responer y el segundo una función callback que se ejecutará una vez que el servidor este listo para recibir
