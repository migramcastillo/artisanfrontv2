...
const PrivacyNoticePage = ({ lang, hreflangs, ...props }) => {
  return (
    <ArtisanFront lang={lang} hreflangs={hreflangs}>
      <Head>
        <title>Aviso de Privacidad - ArtisanFront</title>
      </Head>
      <div className="container py-4 px-2 mx-auto">
        <h1 className="uppercase text-xl font-semibold my-2">
          Política de Privacidad
        </h1>
        <p>
          El presente Política de Privacidad establece los términos en que
          ArtisanFront usa y protege la información que es proporcionada por sus
        ...
        <p>
          ...
          proporcione y podrán ser cancelados en cualquier momento. ArtisanFront
          está altamente comprometido para cumplir con el compromiso de mantener
          su información segura. Usamos los sistemas más avanzados y los
          actualizamos constantemente para asegurarnos que no exista ningún
          acceso no autorizado.
        </p>
        <h2 className="text-lg font-semibold my-2">Cookies</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold my-2">Enlaces a Terceros</h2>{" "}
        <p>
        ...
        <p>
          ...
          que sea requerido por un juez con un orden judicial. ArtisanFront Se
